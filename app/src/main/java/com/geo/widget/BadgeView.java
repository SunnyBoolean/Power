...
//        OvalShadowDrawable(int radius, ColorStateList colorStateList, float shadowSize, float shadowOffset, int animDuration)
        ColorStateList state = ColorStateList.valueOf(badgeColor);
        OvalShape ovalShape = new OvalShape();
        RoundRectShape roundRect = new RoundRectShape(radiusArray, null, null);
        ShapeDrawable bgDrawable = new ShapeDrawable(ovalShape);
